        ...
        <Space>
          ...
          >
            <span
              ...
              className="absolute -top-0.5 right-0 z-1 h-2 w-2 rounded-full bg-red-600 animate-pulse"
            >
              <span className="absolute -z-1 inline-flex h-full w-full animate-ping rounded-full bg-slate-400 opacity-75"></span>
            </span>
